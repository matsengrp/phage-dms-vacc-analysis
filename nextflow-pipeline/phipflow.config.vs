...
params{
    ...
    dataset_prefix = '06-29-21-bowtie2'
    ...
    align_args = '--trim3 32 --threads 4 -N 0 --no-1mm-upfront'

    
    // ##### Sample Table #####
    // csv defining all sample metadata
    // See README for Details
    sample_table = 'sample_table_master_06_24_21.csv'
